...
import (
	...
	"landing-api-poller/models/capacities"
	capacitiesModels "landing-api-poller/models/capacities"
	"landing-api-poller/models/dto"
	"landing-api-poller/pkg/app"
	"landing-api-poller/pkg/cloudstack"
	"landing-api-poller/pkg/conf"
	"landing-api-poller/utils/requestutils"
	"log"
	"math"
	"sync"
	"time"
